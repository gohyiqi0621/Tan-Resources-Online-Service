          ...
          <div class="card-body p-4">
             <div class="position-relative mb-5">
              ...
              <div class="profile-avatar position-absolute top-100 start-50 translate-middle">
                ...
                class="rounded-circle p-1 bg-grd-danger shadow" width="170" height="170" alt="">
              </div>
             </div>
            ...
            <div class="card rounded-4 border-top border-4 border-primary border-gradient-1">
              <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between mb-3">
                 ...
                 <form class="row g-4" action="user-profile-update.php" method="POST" enctype="multipart/form-data">
                  <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                      ...
                      <input type="text" class="form-control" id="input3" name="phone_number" placeholder="Phone"
                            value="<?php echo htmlspecialchars($user['phone_number'] ?? ''); ?>" required>
                  </div>

                  <div class="col-md-12">
                      <label for="input4" class="form-label">Email</label>
                      <input type="email" class="form-control" id="input4" name="email" placeholder="Email"
                            value="<?php echo htmlspecialchars($user['email'] ?? ''); ?>" required>
                  </div>

                  <div class="col-md-12">
                      <label for="input5" class="form-label">Password</label>
                      <input type="password" class="form-control" id="input5" name="password" placeholder="Enter new password if needed">
                  </div>

                  <div class="col-md-12">
                      <label for="input11" class="form-label">Address</label>
                      <textarea class="form-control" id="input11" name="address" placeholder="Address ..." rows="4" cols="4"><?php echo htmlspecialchars($user['address'] ?? ''); ?></textarea>
                  </div>
                  ...
                  <div class="col-md-12">
                      <div class="d-md-flex d-grid align-items-center gap-3">
                          ...
                          <button type="button" class="btn btn-light px-4" onclick="window.location.href='user-profile.php';">Back</button>
                      </div>
                  </div>
              </form>
