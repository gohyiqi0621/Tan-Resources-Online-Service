				...
				<div class="col-lg-10">
					<nav class="hendrio_menu">
						<ul class="nav_scroll">
							...
							<li><a href="../service.html"><a href="service.html">Services <span></span></a></li>
						...
						<div class="header-menu-right-btn">
							...
							<div class="header-search-button search-box-outer">
								<a href="viewprofile.php"><i class='bx bx-user-circle'></i></a>
							</div>
						</div>
					</nav>
				</div>
    ...
    <script>
        function confirmDelete() {
            if (confirm("Are you sure you want to delete your account? This action cannot be undone.")) {
                // Redirect to delete account page or perform delete action
            }
        }
    </script>
